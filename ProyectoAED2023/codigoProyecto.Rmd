...
En el Cuadro \ref{tabla2} observamos que el porcentaje de datos faltantes no es significativo en ninguna de las variables, a excepción de `PM1`. Por ello, podemos considerar que esta variable no nos aportará información suficiente y podemos eliminarla de nuestro análisis.   
...
print(p3)
```
Como comentábamos con anterioridad, los días laborables y los que no son claramente distinguibles. Las concentraciones mantienen levemente la forma, a costa de reducir en gran medida sus valores absolutos. Esto es debido principalmente a la ausencia de necesidad de desplazarse al trabajo, al colegio o a otras zonas de interés.
