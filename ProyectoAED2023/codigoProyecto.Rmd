...
Nuestro objetivo principal era determinar si existía un aumento en la concentración de contaminantes atmosféricos en horas punta. Para ello estudiamos la concentración pormenorizada de los gases por horas y días para una zona de alto tránsito con gran variedad de sensores. A partir de los datos analizados en este trabajo nos aventuramos a afirmar que dicha relación existe. La concentración de gases experimenta picos en horas las horas punta de los días laborables. Por otro lado, aunque los picos de contaminación son menores los sábados y domingos, estos existen en las mismas horas, a menor escala. Los compuestos que más ven incrementada su concentración son los óxidos de nitrógeno, muy estrechamente relacionados con los combustibles fósiles. La concentracione de O$_3$ no presenta la misma dependencia con el tráfico que los óxidos de nitrógeno. Es probable que su comportamiento a lo largo del día no dependa estrechamente de factores antropológicos. 
