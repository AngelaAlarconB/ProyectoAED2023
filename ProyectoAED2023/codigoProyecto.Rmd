...
```{r results='hide'}
rvvcca_d_horarios_2016_2020 <- rvvcca_d_horarios_2016_2020[, colSums(is.na(rvvcca_d_horarios_2016_2020)) < nrow(rvvcca_d_horarios_2016_2020)]
```
...
Vamos ahora a estudiar la evolución de las concentraciones según el día de a semana cada hora:
```{r,message=FALSE}
