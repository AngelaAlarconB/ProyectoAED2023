...
Por consiguiente, a partir de este punto, se considera adecuado enfocar el análisis exclusivamente en el NOx para simplificar la investigación, dada su representatividad y la relación intrínseca con los óxidos de nitrógeno clave en la atmósfera.   
...
for (dia in orden_dias) {
  ...
  if (nrow(df_media_dia) > 0) {
    ...
    #ggsave(paste0("./grafs/grafico_", dia, ".png"), plot = p, device = "png", width = 6, height = 2.5, units ="in")
  }
}
```
...
* A las horas de entrar a trabajar/estudiar.  
 ...
 Este fenómeno destaca la necesidad de estrategias para mitigar las emisiones vehiculares y mejorar la calidad del aire en entornos urbanos.
